    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px]
                        bg-gradient-to-b from-blue-600/[0.08] via-blue-600/[0.03] to-transparent
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8 relative text-center">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight mb-8"
        >
        ...
        <motion.p
          ...
          className="text-white/40 text-lg leading-relaxed mb-4"
        >
          The most common thing we hear from new clients is: <em className="text-white/50">"I wish we'd done this a year ago."</em>
        </motion.p>
        ...
        <motion.p
          ...
          className="text-white/35 text-base leading-relaxed mb-12"
        >
        ...
        <motion.p
          ...
          className="text-xs text-white/20 mt-10 max-w-md mx-auto"
        >
