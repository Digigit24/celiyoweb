    ...
    <section className="relative py-32 mesh-gradient-dark overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full
                        bg-gradient-to-br from-blue-600/[0.04] to-amber-500/[0.02] blur-[100px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative">
        ...
        >
          ...
          <span className="text-white/50">They're the Ones With the Best Systems.</span>
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-white/40 text-lg leading-relaxed max-w-2xl"
        >
        ...
        <motion.p
          ...
          className="text-white/60 text-lg font-semibold mt-6"
        >
